...
public class ContactService {
    ...
    /*******
    * this is used to in dev to populate the db with data
     *the annotation here tells spring to do this after constructing the ContactService
    * */
    @PostConstruct
            ...
            contactRepository.saveAll(
                    Stream.of("Gabrielle Patel", "Brian Robinson", "Eduardo Haugen",
                            ...
                            .map(name -> {
                                ...
                                contact.setCompany(companies.get(rand.nextInt(companies.size())));
                                contact.setStatus(Contact.Status.values()[rand.nextInt(Contact
